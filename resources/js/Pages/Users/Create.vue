                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <input v-model="form.pin" type="password" maxlength="4" class="w-full px-3.5 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none" />
                    ...
                    <div class="flex gap-3 pt-4">
                        <button type="submit" :disabled="form.processing" class="bg-primary-600 text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-primary-700 transition disabled:opacity-50">Create User</button>
...
const form = useForm({ name: '', email: '', pin: '', role: 'cashier', store_id: '' });
